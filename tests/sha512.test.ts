...
describe('hex_hmac_sha512', function () {
    it('hex_hmac_sha512 hexcase default', function () {
    ...
    it('hex_hmac_sha512 hexcase false', function () {
        let result = sha512.with_hexcase(false).hex_hmac_sha512("key", "data")
        expect(result).equal("3c5953a18f7303ec653ba170ae334fafa08e3846f2efe317b87efce82376253cb52a8c31ddcde5a3a2eee183c2b34cb91f85e64ddbc325f7692b199473579c58");
    });
    it('hex_hmac_sha512 hexcase true', function () {
